...
#编译容器镜像
docker build -t marco/tcpip .

publiceth="enp0s3"
imagename="marco/tcpip"
...
ovs-vsctl add-br net10
ip link set net10 up
ovs-vsctl add-br net20
ip link set net20 up
...
./pipework net10 aix 140.252.1.92/24
./pipework net10 solaris 140.252.1.32/24
./pipework net10 gemini 140.252.1.11/24
./pipework net10 gateway 140.252.1.4/24
./pipework net10 netb 140.252.1.183/24

./pipework net20 bsdi 140.252.13.35/27
./pipework net20 sun 140.252.13.33/27
./pipework net20 svr4 140.252.13.34/27
...
iptables -t nat -A POSTROUTING -s 140.252.0.0/16 -j MASQUERADE
